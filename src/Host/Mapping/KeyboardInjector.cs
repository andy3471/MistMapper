...
public static class KeyboardInjector
{
    ...
    public static void SetModifier(Shared.KeyModifiers modifier, bool down)
    {
        if (modifier.HasFlag(Shared.KeyModifiers.Ctrl)) SetKey(0x11, down);
        if (modifier.HasFlag(Shared.KeyModifiers.Alt)) SetKey(0x12, down);
        if (modifier.HasFlag(Shared.KeyModifiers.Shift)) SetKey(0x10, down);
        if (modifier.HasFlag(Shared.KeyModifiers.Win)) SetKey(0x5B, down);
    }
